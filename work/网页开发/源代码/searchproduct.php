				...
				<form action="index.php" method="post" enctype="multipart/form-data">
					<table border="1">
						...
						<tr>
							<th>退换服务：</th>
							<td>
								<label><input <?php if ($arr["sex"]=="有" ) { echo "checked" ; } ?> type="radio" name="sex" value="有" disabled="disabled">有</label>
								<label><input <?php if ($arr["sex"]=="无" ) { echo "checked" ; } ?> type="radio" name="sex" value="无" disabled="disabled">无</label>
							</td>
						</tr>
						<tr>
							<th>库   存：</th>
